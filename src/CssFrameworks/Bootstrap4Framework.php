...
class Bootstrap4Framework implements CssFramework
{
    ...
    {
        return ['alert', "alert-{$this->bsVariant($variant)}"];
    }
    ...
    {
        return ['form-control', 'custom-select'];
    }
    ...
    {
        $classes = ['badge', "badge-{$this->bsVariant($variant)}"];
        if ($pill) {
            $classes[] = 'badge-pill';
        }
        return $classes;
